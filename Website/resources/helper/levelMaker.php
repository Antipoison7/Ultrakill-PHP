<?php
    include_once 'C:\Users\order\Github\UltrakillPHP\Ultrakill-PHP\Website\resources\helper\databaseHelper.php';
    include_once 'C:\Users\order\Github\UltrakillPHP\Ultrakill-PHP\Website\resources\helper\numberConversion';
?>
...
<?php
    function basicGetLevel($levelCode)
    {
        ...
        $generatedString .= "<img src='../images/Thumbnails/" . $levelDetails["LevelCode"] . ".webp'>";
        $generatedString .= "
                                    </div>
        ...
        while ($row = $levelARun->fetchArray())
        {
